...
def main():
    ...
    # set num_classes
    cfg.model.roi_head.bbox_head.num_classes = cfg.num_classes
    ...
    if wandb_hook_index:
        ...
        # https://mmcv.readthedocs.io/en/latest/api.html#mmcv.runner.WandbLoggerHook
        ...
        #  - define_metric_cfg (dict, optional) – A dict of metrics and summaries for wandb.define_metric. The key is metric and the value is summary. The summary should be in [“min”, “max”, “mean” ,”best”, “last”, ”none”].
        ...
        print(wandb_hook)
        print(wandb_hook.init_kwargs.tags)

        wandb_hook.init_kwargs.config = cfg._cfg_dict
        #     wandb_hook.init_kwargs.config = {
        #         'list': [1,2,3],
        #         'tuple': ('1', '2', '3'),
        #         'boolean': True,
        #         'string': 'hello world',
        ...
        #         }
        #     }
        wandb_hook.init_kwargs.config["exp_name"] = osp.basename(args.config)
        # TODO: tags 추가하기
        # wandb_hook.init_kwargs.tags.append()

        wandb_hook.init_kwargs.name = osp.basename(args.config)
